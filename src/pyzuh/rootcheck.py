...
class Rootcheck: 
    ...
    def clear_results(self, pretty: bool = False, wait_for_complete: bool = False, agent_id = str) -> dict:
        """
    ...
    def get_lastscan(self, pretty: bool = False, wait_for_complete: bool = False, agent_id = str) -> dict:
        """
